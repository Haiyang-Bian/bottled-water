...
class TaskReader(Protocol):
    def search(self, access: ResourceAccessContext, query="", **options): ...
    def read(self, access: ResourceAccessContext, identifier: str): ...
    def exists(self, access: ResourceAccessContext, identifier: str) -> bool: ...


class SoftwareDriver(Protocol):
    async def verify(self, record, kind, cwd, context) -> SoftwareSpec: ...
    async def run(self, cfg: SoftwareSpec, args, context, **options) -> dict: ...

...
2026-09-15 增补的[本机持续记忆设计](./local-agent-environment.md)扩展 S4、S6 与宿主身份职责；L1 身份、全局任务与独立位置已在 0.2.0 实现，其余按[开发阶段](./local-agent-roadmap.md)追踪。下表的已实现位置不因此获得全局记忆或强隔离能力。
